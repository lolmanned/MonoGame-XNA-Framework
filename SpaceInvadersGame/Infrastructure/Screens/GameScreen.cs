...
namespace Infrastructure.Screens
{
    ...
    public abstract class GameScreen : CompositeDrawableComponent<IGameComponent>
    {
        ...
        /// PROPS:
        /// <summary>
        /// Sets the background texture2D of the screen.
        /// </summary>
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                m_SpriteBatch.Draw(m_Background, Game.GraphicsDevice.Viewport.Bounds, Color.White);
            }
        ...
        public void FadeBackBufferToBlack(byte i_Alpha)
        {
            ...
            SpriteBatch.Draw(background, new Rectangle(0, 0, viewport.Width, viewport.Height), new Color());
            SpriteBatch.End();
        }
