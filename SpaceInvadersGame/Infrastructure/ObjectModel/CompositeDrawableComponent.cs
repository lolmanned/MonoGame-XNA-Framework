...
namespace Infrastructure.ObjectModel
{
        ...
        where ComponentType : IGameComponent
    {
        ...
        public Collection<ComponentType> m_Components = new Collection<ComponentType>();
        ...
        public CompositeDrawableComponent(GameScreen i_GameScreen) : base(i_GameScreen.Game)
        {
